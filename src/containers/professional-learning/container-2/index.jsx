...
const ProfessionalLearningContainerTwo = ({ data }) => {
  ...
  return (
    <div className='professional-learning-container-2 section-with-padding'>
...
export default ProfessionalLearningContainerTwo