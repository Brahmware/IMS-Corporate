...
const ImmersiveExperienceContainerTwo = ({ data }) => {
  ...
  return (
    <div className='immersive-experience-container-2 section-with-padding'>
...
export default ImmersiveExperienceContainerTwo